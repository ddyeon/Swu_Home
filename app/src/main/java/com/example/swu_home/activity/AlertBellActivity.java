...
public class AlertBellActivity extends AppCompatActivity {

    public AlertBellActivity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alert_bell);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                a.cancel();
                Intent intent = new Intent(AlertBellActivity.this, MainActivity.class);
