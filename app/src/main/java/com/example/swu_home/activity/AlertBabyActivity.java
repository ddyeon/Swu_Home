...
public class AlertBabyActivity extends AppCompatActivity {

    public AlertBabyActivity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alert_baby);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                a.cancel();
                Intent intent = new Intent(AlertBabyActivity.this, MainActivity.class);
